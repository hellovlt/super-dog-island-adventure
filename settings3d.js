...
export const DEFAULTS={follow:'gentle',look:1,invertY:false,zoom:'medium',effects:true,music:.7,sfx:1,hints:true};
...
export function parseSettings(raw){
 ...
 return {follow:choice(d.follow,FOLLOW,DEFAULTS.follow),look:number(d.look,.4,2,DEFAULTS.look),invertY:d.invertY===true,
  zoom:choice(d.zoom,ZOOM,DEFAULTS.zoom),effects:d.effects!==false,music:number(d.music,0,1,DEFAULTS.music),sfx:number(d.sfx,0,1,DEFAULTS.sfx),hints:d.hints!==false};
}
